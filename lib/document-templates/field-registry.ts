...
export const FIELD_REGISTRY = {
  ...
  fiscal_year_start: {
    ...
    mergeTag: "{{fiscal_year_start}}",
    label: "Fiscal Year Start",
    type: "text",
    sources: ["ocr", "cache", "manual"],
    ocrFieldKey: "fiscal_year_start",
    description: "Month and day the association's fiscal year begins (e.g. January 1).",
    communityLevel: true,
  },
  assessment_frequency: {
    key: "assessment_frequency",
    mergeTag: "{{assessment_frequency}}",
    label: "Assessment Frequency",
    type: "text",
    sources: ["ocr", "cache", "manual"],
    ocrFieldKey: "assessment_frequency",
    description: "How often dues are billed: Monthly, Quarterly, Semi-Annual, Annual, or Other.",
    communityLevel: true,
  },
  transfer_fee: {
    key: "transfer_fee",
    mergeTag: "{{transfer_fee}}",
    label: "Transfer Fee",
    type: "currency",
    sources: ["ocr", "cache", "manual"],
    ocrFieldKey: "transfer_fee",
    description: "One-time transfer fee charged at closing per association docs.",
    communityLevel: true,
  },
  transfer_fee_paid_by: {
    key: "transfer_fee_paid_by",
    mergeTag: "{{transfer_fee_paid_by}}",
    label: "Transfer Fee Paid By",
    type: "text",
    sources: ["ocr", "cache", "manual"],
    ocrFieldKey: "transfer_fee_paid_by",
    description: "Who pays the transfer fee — Seller, Buyer, or N/A.",
    communityLevel: true,
  },
  maintenance_reserve_fee_new_buyer: {
    key: "maintenance_reserve_fee_new_buyer",
    mergeTag: "{{maintenance_reserve_fee_new_buyer}}",
    label: "Maintenance Reserve Fee (New Buyer)",
    type: "currency",
    sources: ["ocr", "cache", "manual"],
    ocrFieldKey: "maintenance_reserve_fee_new_buyer",
    description: "One-time reserve contribution required from a new buyer at closing.",
    communityLevel: true,
  },
  first_right_of_refusal: {
    key: "first_right_of_refusal",
    mergeTag: "{{first_right_of_refusal}}",
    label: "Association Has First Right of Refusal",
    type: "boolean",
    sources: ["cache", "manual"],
    description: "Whether the association has a first right of refusal on unit sales (per the CC&Rs).",
    communityLevel: true,
  },
  first_right_of_refusal_exercised: {
    key: "first_right_of_refusal_exercised",
    mergeTag: "{{first_right_of_refusal_exercised}}",
    label: "Association Wishes to Exercise First Right of Refusal",
    type: "boolean",
    sources: ["manual"],
    description: "For this transaction specifically, whether the board is exercising its first right of refusal.",
    communityLevel: false,
  },
  additional_associations_apply: {
    key: "additional_associations_apply",
    mergeTag: "{{additional_associations_apply}}",
    label: "Property Subject to Additional Associations",
    type: "boolean",
    sources: ["cache", "manual"],
    description: "Whether the unit is subject to one or more additional HOAs / sub-associations.",
    communityLevel: true,
  },
  road_maintenance_apply: {
    key: "road_maintenance_apply",
    mergeTag: "{{road_maintenance_apply}}",
    label: "Property Subject to Road Maintenance Agreement",
    type: "boolean",
    sources: ["cache", "manual"],
    description: "Whether the unit is part of a private-road maintenance arrangement.",
    communityLevel: true,
  },
  account_paid_through: {
    key: "account_paid_through",
    mergeTag: "{{account_paid_through}}",
    label: "Account Paid Through",
    type: "date",
    sources: ["manual"],
    description: "Date through which the homeowner's account is current. Per-unit ledger data — no auto-source today; staff fills manually.",
    communityLevel: false,
  },
  account_balance_owed: {
    key: "account_balance_owed",
    mergeTag: "{{account_balance_owed}}",
    label: "Account Balance Owed",
    type: "currency",
    sources: ["manual"],
    description: "Outstanding balance owed by the homeowner. Per-unit ledger data — no auto-source today; staff fills manually.",
    communityLevel: false,
  },
  mailing_address: {
    key: "mailing_address",
  ...
  property_account_number: {
    key: "property_account_number",
    mergeTag: "{{property_account_number}}",
    label: "Property Account Number",
    type: "text",
    sources: ["order"],
    description:
      "Source-PMS account ID for the unit (e.g. Vantaca account #). Resolved by looking up the order's property in the community_units roster.",
    communityLevel: false,
  },
  property_city: {
    key: "property_city",
    mergeTag: "{{property_city}}",
    label: "Property City",
    type: "text",
    sources: ["order"],
    description: "City portion of the property address.",
    communityLevel: false,
  },
  property_state: {
    key: "property_state",
    mergeTag: "{{property_state}}",
    label: "Property State",
    type: "text",
    sources: ["order"],
    description: "Two-letter state of the property address.",
    communityLevel: false,
  },
  property_zip: {
    key: "property_zip",
    mergeTag: "{{property_zip}}",
    label: "Property ZIP",
    type: "text",
    sources: ["order"],
    description: "ZIP/postal code of the property address.",
    communityLevel: false,
  },
  property_lease_status: {
    key: "property_lease_status",
    mergeTag: "{{property_lease_status}}",
    label: "Lease Status",
    type: "text",
    sources: ["order", "manual"],
    description:
      "Owner-occupied vs leased status, when known from the unit roster.",
    communityLevel: false,
  },
  owner_name: {
    key: "owner_name",
    ...
    sources: ["order", "manual"],
    description:
      "Primary owner of record for the unit (first entry in the roster's owner_names array).",
    communityLevel: false,
  },
  owner_full_names: {
    key: "owner_full_names",
    mergeTag: "{{owner_full_names}}",
    label: "Owner Full Names",
    type: "text",
    sources: ["order", "manual"],
    description:
      "All owners of record, joined with ' & ' (e.g. \"Peter Abigania & A Abigania\"). Falls back to owner_name when there's only one.",
    communityLevel: false,
  },
  owner_email: {
    key: "owner_email",
    mergeTag: "{{owner_email}}",
    label: "Owner Email",
    type: "text",
    sources: ["order", "manual"],
    description:
      "Primary contact email for the owner. Comes from the roster's primary_email column.",
    communityLevel: false,
  },
  owner_phone: {
    key: "owner_phone",
    mergeTag: "{{owner_phone}}",
    label: "Owner Phone",
    type: "text",
    sources: ["order", "manual"],
    description: "Owner phone number from the unit roster.",
    communityLevel: false,
  },
  owner_mailing_street: {
    key: "owner_mailing_street",
    mergeTag: "{{owner_mailing_street}}",
    label: "Owner Mailing Street",
    type: "text",
    sources: ["order", "manual"],
    description:
      "Street portion of the owner's mailing address. Often equal to property_address but differs for non-resident / investor owners.",
    communityLevel: false,
  },
  owner_mailing_city: {
    key: "owner_mailing_city",
    mergeTag: "{{owner_mailing_city}}",
    label: "Owner Mailing City",
    type: "text",
    sources: ["order", "manual"],
    description: "City portion of the owner's mailing address.",
    communityLevel: false,
  },
  owner_mailing_state: {
    key: "owner_mailing_state",
    mergeTag: "{{owner_mailing_state}}",
    label: "Owner Mailing State",
    type: "text",
    sources: ["order", "manual"],
    description: "Two-letter state of the owner's mailing address.",
    communityLevel: false,
  },
  owner_mailing_zip: {
    key: "owner_mailing_zip",
    mergeTag: "{{owner_mailing_zip}}",
    label: "Owner Mailing ZIP",
    type: "text",
    sources: ["order", "manual"],
    description: "ZIP/postal code of the owner's mailing address.",
    communityLevel: false,
  },
  requester_name: {
    key: "requester_name",
